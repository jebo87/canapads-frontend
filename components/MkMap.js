...
import {
    dataLayerClusterCount,
    dataLayerClusters,
    dataLayerUnclustered
} from './layer_data/layer_data';
    ...
    return (
        <div className="map" id="map">
            ...
            >
                {_renderPopup()}
                {
                    props.ads && (<Source type="geojson" id="listings"  {...{ cluster: true, clusterMaxZoom: 14, clusterRadius: 50 }} data={props.ads}>
