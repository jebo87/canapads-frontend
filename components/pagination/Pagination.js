...
import { setPagesVisible } from './../../redux/actions/paginationActions';
...
const Pagination = (props) => {
	...
	const pagesVisible = useSelector((state) => state.pagesVisible);
	const { selectedPage, pages, filter } = usePagination();
